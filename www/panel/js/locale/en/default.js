...
export default {
	...
	'code.metrics': "You can accumulate custom metrics in your code. Those values are reported like other built-in metrics.",
	...
	'home.limit.tooltip.disk': "Disk space on the default storage location",
	...
	'security.consumer.login': "Login",
	'security.consumer.login.anonymous': "<em>anonymous</em>",
	'security.consumer.enable': "Enable login",
	'security.consumer.enable.prompt': "Assign a login name to allow this consumer to sign in.",
	'security.consumer.enable.empty': "Login cannot be empty",
	'security.consumer.enable.success': "Login enabled",
	'security.consumer.enable.error': "Could not enable login",
	'security.consumer.enable.result': "The temporary password is:<br /><em>{}</em><br />Copy it now because it cannot be recovered later.",
	'security.consumer.anonymize': "Anonymize",
	'security.consumer.anonymize.confirm': "Remove the login and password of <em>{}</em>? The consumer will no longer be able to sign in.",
	'security.consumer.anonymize.success': "Consumer anonymized",
	'security.consumer.anonymize.error': "Could not anonymize consumer",
	'security.consumer.reset_password': "Reset password",
	'security.consumer.reset.confirm': "Generate a new random password for <em>{}</em>? The previous password will no longer work.",
	'security.consumer.reset.success': "Password reset",
	'security.consumer.reset.error': "Could not reset password",
	'security.consumer.reset.result': "The new password is:<br /><em>{}</em><br />Copy it now because it cannot be recovered later.",
	'security.consumer.tags': "Tags:",
	'security.consumer.tag.add': "Add tag",
	'security.consumer.tag.edit': "Edit tag <em>{}</em>:",
	'security.consumer.tag.key': "Tag",
	'security.consumer.tag.value': "Value",
	'security.consumer.tag.empty': "Tag name cannot be empty",
	'security.consumer.tag.success': "Tag updated",
	'security.consumer.tag.error': "Could not update tag",
	'security.consumer.tag.remove.confirm': "Remove tag <em>{}</em>?",
	'security.consumer.tag.remove.success': "Tag removed",
	'security.consumer.tag.remove.error': "Could not remove tag",
	'security.consumer.tags.edit': "Edit tags",
	...
	'me.password.current.empty': "Current password is required",
	...
	'me.tokens': "Access tokens",
	'me.tokens.explain': "Access tokens represent your full account. Anyone holding one can act with all permissions you normally have. <em>Keep them strictly confidential.</em> Some system features use tokens with a defined technical purpose, you can manage those tokens in this section.",
	'me.token.copy': "Copy token",
	'me.token.copied': "Token copied to clipboard",
	'me.token.remove': "Remove permanently",
	'me.token.rotate': "Rotate key",
	'me.token.rotate.success': "Token rotated",
	'me.token.rotate.error': "Could not rotate token",
	'me.token.delete.success': "Token removed",
	'me.token.delete.error': "Could not remove token",
	'me.token.create': "New Token",
	'me.token.scope': "Special grant",
	'me.token.validity': "Hours of validity",
	'me.token.validuntil': "Valid until: <em>{}</em>",
	'me.token.permanent': "Valid forever",
	...
	'apps.title': "Client Applications",
	'apps.explain': "Register your own frontend applications so your end users can sign in through this instance's login system. Each application becomes a public OAuth client (PKCE), identified by a generated <em>client id</em>.",
	'apps.add': "Register application",
	'apps.empty': "No application registered yet.",
	'apps.name': "Application name",
	'apps.name.empty': "Application name cannot be empty",
	'apps.redirect': "Redirect URI",
	'apps.redirect.empty': "Redirect URI cannot be empty",
	'apps.redirect.explain': "Where the login flow sends users back after authentication. Use a full <em>https://</em> URL, or a single leading-slash path (e.g. <em>/myapp</em>) for an app hosted on this instance.",
	'apps.client_id': "Client id",
	'apps.add.success': "Application registered",
	'apps.add.error': "Could not register the application",
	'apps.delete.confirm': "<em>Whoa, easy!</em> Be careful with this.<br /><br />Are you sure you want to remove the application <em>{}</em> ?<br />"
		+ "Its users will no longer be able to sign in through this instance.",
	'apps.delete.success': "Application removed",
	'apps.delete.error': "Could not remove the application",
	'apps.copy': "Copy client id",
	'apps.copied': "Client id copied to clipboard",
	'apps.doc': "How to wire your app to the login system",
	...
	'endpoints.workspace.delete.confirm': "<em>Whoa, easy!</em> Be careful with this.<br /><br />Are you sure you want to remove the workspace <em>{}</em> ?<br />"
		+ "All endpoints in this workspace will be removed too.<br /><br />Please detail the reason for removing this workspace.",
	...
	'endpoints.safecode.label': "Safe mode",
	'endpoints.safecode.title': "Safe code execution",
	'endpoints.safecode.hint': "Toggle code restrictions for this instance",
	'endpoints.safecode.locked': "Only a manager on a dedicated plan can change this",
	'endpoints.safecode.disable.confirm': "You are about to lift code restrictions. Published code will be able to use any type and can compromise this instance from the inside. Only proceed if you understand and accept the risk. Enter your multifactor code to confirm:",
	'endpoints.safecode.enable.confirm': "You are about to re-enable code restrictions. The instance will reboot to re-enforce them, and any published code that violates the restrictions will fail to recompile until fixed. Enter your multifactor code to confirm:",
	'endpoints.safecode.doc': "About safe mode and its impact",
	'endpoints.safecode.apply': "Confirm",
	'endpoints.safecode.mfa': "Multifactor code",
	'endpoints.safecode.mfa.missing': "Multifactor code missing",
	'endpoints.safecode.success': "Safe mode updated",
	'endpoints.safecode.rebooting': "Code restrictions re-enabled. The instance is rebooting to re-enforce them…",
	'endpoints.safecode.error': "Could not update safe mode",

	'endpoint.back': "Endpoint list",
	'endpoint.delete': "Delete Endpoint",
	'endpoint.delete.confirm': "Please detail the reason for removing this endpoint.",
	...
	'troubleshoot.download': "Download Logs",
	'troubleshoot.delete': "Clear Logs",
	'troubleshoot.delete.confirm': "Clear all logs before the selected date:",
	'troubleshoot.delete.success': "Logs cleared",
	'troubleshoot.delete.error': "Could not clear logs",
	'troubleshoot.download.confirm': "Download logs between two dates:",
	'troubleshoot.download.success': "Logs downloaded",
	'troubleshoot.download.error': "Could not download logs",
	...
	'storage.database.size': "Maximum connections",
	'storage.database.path': "Path",
	...
	'storage.git.flatten': "Compact History",
	'storage.git.flatten.confirm': "<em>Whoa, easy!</em> Be careful with this.<br /><br />This will squash the entire git history into a single commit. "
		+ "Your current files are untouched but all history is lost.<br />"
		+ "Anyone with a clone will need to <em>re-clone</em> the repository.",
	'storage.git.flatten.success': "Git history compacted",
	'storage.git.flatten.error': "Could not compact git history",
	'storage.git.reset': "Reset Repository",
	'storage.git.reset.confirm': "<em>Whoa, easy!</em> Be careful with this.<br /><br />This will <em>permanently delete</em> all files, endpoints, and workspaces "
		+ "from the git repository and reinitialize it from scratch.<br /><br />"
		+ "<strong>This action cannot be undone.</strong>",
	'storage.git.reset.success': "Git repository reset",
	'storage.git.reset.error': "Could not reset git repository",
	'storage.explorer': "Browse",

	'explorer.upload': "Upload",
	'explorer.upload.success': "File uploaded",
	'explorer.upload.error': "Could not upload file",
	'explorer.upload.size': "File size exceeds the limit",
	'explorer.newfolder': "New Folder",
	'explorer.newfolder.prompt': "Folder name",
	'explorer.newfolder.success': "Folder created",
	'explorer.newfolder.error': "Could not create folder",
	'explorer.delete.confirm': "Are you sure you want to delete <em>{}</em> ?",
	'explorer.delete.success': "Deleted successfully",
	'explorer.delete.error': "Could not delete",
	'explorer.download.error': "Could not download file",
	'explorer.sql': "SQL",
	'explorer.sql.title': "Execute SQL",
	'explorer.sql.execute': "Execute",
	'explorer.sql.success': "Query executed successfully",
	'explorer.sql.error': "Query failed",
	'explorer.sql.rows': "{} rows affected",
	'explorer.empty': "This location is empty",
	'explorer.empty.drop': "Drop files here to upload",
	'explorer.addrow': "Add Row",
	'explorer.addrow.success': "Row inserted",
	'explorer.addrow.error': "Could not insert row",
	'explorer.editrow': "Edit Row",
	'explorer.editrow.success': "Row updated",
	'explorer.editrow.error': "Could not update row",
	'explorer.nopk': "Edit and delete are disabled because this table has no primary key. Use SQL instead.",
	'explorer.filter.placeholder': "Filter...",
	'explorer.refresh': "Refresh",
	'explorer.schema.error': "Could not load schema",
	'explorer.tree.error': "Could not load directory",
	'explorer.query.error': "Could not load data",

	'metrics.title': "Metrics",
	'metrics.explain': "Metrics are accumulated <em>per minute</em> and provide insights about the behavior of the platform.",
	'metrics.clear': "Clear History",
	'metrics.download': "Download",
	'metrics.tab.api': "Endpoints",
	'metrics.tab.user': "Users",
	'metrics.tab.custom': "Custom",
	'metrics.graph.title.hits': "Total number of API calls (hits)",
	'metrics.graph.hits': "Hits",
	'metrics.graph.title.ratio': "Success / Error ratio (%)",
	'metrics.graph.ratio': "%",
	'metrics.graph.title.time': "Average response time (ms)",
	'metrics.graph.time': "ms",
	'metrics.delete.confirm': "Clear all metrics data before the selected date:",
	'metrics.delete.success': "Metrics cleared",
	'metrics.delete.error': "Could not clear metrics",
	'metrics.download.confirm': "Download metrics data between two dates:",
	'metrics.download.success': "Metrics downloaded",
	'metrics.download.error': "Could not download metrics",
	'metrics.graph.title.count': "Total number of hits",
	'metrics.graph.title.sum': "Cumulated sum of metric value",
	'metrics.graph.sum': "Value",
	'metrics.graph.serie.api': "Api Requests",
	'metrics.graph.serie.success': "Success",
	'metrics.graph.serie.error': "Error",
	'metrics.graph.serie.time': "Response time",
	'metrics.graph.serie.slow': "Slowest",
	'metrics.graph.filter.all': "- All -",
	'metrics.graph.title.table': "Details",
	'metrics.table.hits': "Hits",
	'metrics.table.sum': "Sum",
	'metrics.range.from': "Show metrics starting at",
	'metrics.range.length': "for",
	'metrics.range.refresh': "Refresh",
	'metrics.range.length.1': "1 hour",
	'metrics.range.length.2': "2 hours",
	'metrics.range.length.4': "4 hours",
	'metrics.range.length.8': "8 hours",
	'metrics.range.length.24': "1 day",
